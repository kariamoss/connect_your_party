...
export class EventService{
  ...
  private events: EventModel[] = [
    ...
    new EventModel(3,'Kermesse','on fait la fête pasqu\'on aura plus à voir la tête de lucas',78,'à l\'ecole','18 juin','kermesse.jpg','event',this.colors[2])
  ];
  ...
  isTypeOfParty(id:number){
    return this.getEventById(id).type == 'party';
  }
